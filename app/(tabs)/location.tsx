    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.relativeform}>
          ...
          />
          <EvilIcons style={styles.icon} name="user" size={24} color="black" />
        </View>
        ...
        <View style={styles.relativeform}>
          <TextInput
            ...
            style={styles.input}
          />
          <Entypo name="email" style={styles.icon} size={15} color="black" />
        </View>
        ...
        <View style={styles.relativeform}>
          ...
          />
          <EvilIcons style={styles.icon} name="lock" size={24} color="black" />
          {showPassword ? (
            <Entypo
              name="eye-with-line"
